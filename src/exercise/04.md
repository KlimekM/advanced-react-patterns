...
Prior to this exercise I hadn't come across the prop getters pattern, but I really liked it and see how it can be extremely extensible as an API that is provided to consumers. I also liked the little helper function callAll that Kent implemented and that I did not use as part of my initial implementation as it makes it easy to allow users of the API to easily forward any additional functionality that they desire and apply it to several handlers.
## Background
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Patterns%20%F0%9F%A4%AF&e=04%3A%20Prop%20Collections%20and%20Getters&em=mklimek15%40gmail.com).
