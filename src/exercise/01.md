...
The Context Module function was a pattern that I have not seen before and it was
interesting, but makes sense from a standpoint of not forcing the user of your
API to call dispatch 2-3 times versus just passing dispatch to the function and
allowing the API author to handle the logic and how they intend for the
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Patterns%20%F0%9F%A4%AF&e=01%3A%20Context%20Module%20Functions&em=mklimek15%40gmail.com).
