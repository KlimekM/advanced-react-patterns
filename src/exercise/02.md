...
I enjoyed this lesson, because I have worked with the compound component pattern
before and have found it to be rather confusing in terms of following the props
being passed down. This simple example made things click a bit for me in that
the parent component is essentially managing the props and passing them down to
the children. It was helpful to log the child within the React.children.map to
see what each is and the props that they are currently receiving.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Patterns%20%F0%9F%A4%AF&e=02%3A%20Compound%20Components&em=mklimek15%40gmail.com).
